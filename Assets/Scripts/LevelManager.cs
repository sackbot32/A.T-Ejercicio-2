...
public class LevelManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hudController.UpdatePoints(GameManager.Instance.TotalPoints);
    ...
    public void EndState(bool win)
    {
        ...
        if (win)
        {
            ...
            endPanel.transform.GetChild(1).gameObject.GetComponent<WinHud>().WinningShow(finalResult,GameManager.Instance.UpdateTotal(finalResult),maxPosiblePoints,percentForMaxRating);
